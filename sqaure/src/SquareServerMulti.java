...
public class SquareServerMulti {
    ...
    private void handle(Socket socket) throws IOException {
        ...
        try (BufferedReader in = new BufferedReader(new InputStreamReader(socket.getInputStream())); PrintWriter out = new PrintWriter(new OutputStreamWriter(socket.getOutputStream()), true)) {
